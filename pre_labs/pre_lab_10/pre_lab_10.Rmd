...
**Answer** https://datawrapper.dwcdn.net/mqB94/1/
...
**Answer** Grouping the data by each county and counting the number of approved applications in each county. 
...
**Answer** Grouping the data by each county and counting the number of approved applications in each county, and filtering for counties with more than 6 applications. 
...
**Answer** 5-digit FIPS codes are now in the data. 
...
**Answer** The two dataframes have been joined (only issue I see is that the county names are listed twice, in different columns. )
...
**Answer** Now, it's just a map of maryland 
...
**Answer** https://datawrapper.dwcdn.net/8X6t1/1/
