...
**We're taking the PPP loan data, grouping the loans by which county they're listed in, and counting the total number of loans in each county. Also, we're ordering it from highest to lowest, and looking at just the top 10 counties in PPP loans.**
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**There's a very basic bar chart of showing the number of loans per county (based on the list of top 10 counties from above).**
...
**The bars are now lined up from lowest number of loans to highest number of loans. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**It's now a horizantal bar chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**The background of the graph is now white instead of gray.**
...
**The entire color format/fonts of the graph has changed. The colors, the details of the graph themselves are different.**
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**The title of the graph is now in bold at the top of the graph, and the labels for the x-axis and y-axis are also labeled appropriately.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**There's a table of the number of loans approved on any given day.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**There's a line graph of the data provided above (PPP loans approved per day).**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**The x-axis now has intervals (on a per-month basis).**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**The x-axis is now spaced out well, so that the labels for the intervals are less crowded.**
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
