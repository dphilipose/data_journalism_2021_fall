...
**It's a breakdown of NAICS codes and how they categorized into different sectors**
...
**It's the HTML page for the webpage.**
...
**It looks like HTML language (head and body tags).**
...
**There's a HTML tag, head tag, and a body tag.**
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**It's HTML code for the page, but I'm looking specifically at the code for Table 2.**
...
**Six different tables appear, each with different data fields.**
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**There's now six different sets of data.**
...
**It shows the tables from the website. **
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**It's "Table 2, NAICS Sectors" from the website.**
...
**The output is the data frame of Table 2.**
...
**The dataframe once again appears, but the table is formatted better than before. **
