...
**Some of the city names are spelled incorrectly or with different capitalizations.**
...
**One change is that "PHOENIX" became "Phoenix," and another change is that "WESTMINSTER" became "Westminster."**
...
**Spelling mistakes were fixed, cities that were in all-caps and cities in all-lowercase were standardized. **
...
**As far as I can tell, there aren't any substantial changes, though n_gram_merge caught at least one mistake that key_collision_merge did not correct (abigdon -> Abingdon)**
