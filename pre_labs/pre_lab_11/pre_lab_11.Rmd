...
**Answer** List of different files, all with the name "Hospital"
...
**Answer** ID, Names, Addresses, Phone numbers, and other geographic data 
...
**Answer** Looks like a table of data describing different hospitals in Maryland
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It's a list of the number of different types of hospitals/care facilities. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It's a table of the different "general acute care" hospitals in Maryland and their associated data. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There's a scatterplot of each hospital's location. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** THe library tigris is loaded, and fips_codes is "masked"
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A dataframe with location data, as well as some other data. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It's the list like before, but filtered down to only counties in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It's a map of Maryland divided by the counties. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The same map as before but now the general acute care hospitals are plotted on the map. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There's now a color code to the plotted points based off of the number of beds each hospital has. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A table with information on hospitals in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There's a list of the number of hospital beds in each county in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** ACS population data according to each MD county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There's the dataframe with CS data but with a new column with geo coordinates. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Number of beds in hospitals per county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The two dataframes have been joined. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Same dataframe as before but with an added column for the number of beds per 100,000 people. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** **Answer** Same data frame as before with an added column for the number of beds per 100,000 people, but the "N/A"s have been replaced with a zero. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There's map of maryland broken down by county, color-coded according to the proportions of hosptial beds available per 100,000 people. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Same map as before but the colors are different and make the data more clear. 
...
**Answer** Most of the hospital beds are in Montgomery, Frederick, Howard Counties, while counties to the south have relatively fewer beds. 
